...
const Inbox = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      const url = `https://clientmailbox-87dff-default-rtdb.firebaseio.com/${userEmail}/inboxMail.json`;
  ...
  const deleteHandler = (key) => {
    const url = `https://clientmailbox-87dff-default-rtdb.firebaseio.com/${userEmail}/inboxMail/${key}.json`;
